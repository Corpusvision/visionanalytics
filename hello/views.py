...
class WeekdaysData(APIView):
    ...
    def get(self, request, format=None):
        ...
        data = pd.read_csv(
            'https://docs.google.com/spreadsheets/d/1LKeVmoCsUXTEQi4r7sFnbl9hGCIcFh_NdxXRgwfo160/pub?output=csv')
...
class CityData(APIView):
    ...
    def get(self, request, format=None):
        ...
        data = {
            "labels": ['San Jose','San Diego', 'Seattle', 'Nashville','Boston','Chicago', 'New York', 'Austin','Tucson', 'Miami'],
            "default": default_items,
        }
        return Response(data)
...
class ConvCityData(APIView):
    ...
    def get(self, request, format=None):
        ...
        default_items = citydata
        data = {
            "labels": ['Charleston','New Orleans', 'Savannah', 'Nashville','San Francisco','Chicago', 'New York', 'Austin','Asheville', 'Honolulu'],
            "default": default_items,
        }
        return Response(data)
...
class ConvSourceData(APIView):
    ...
    def get(self, request, format=None):
        ...
        data = data = pd.read_csv('https://docs.google.com/spreadsheets/d/1LKeVmoCsUXTEQi4r7sFnbl9hGCIcFh_NdxXRgwfo160/pub?output=csv')
...
def converting_keyword(request):
    data = pd.read_csv('https://docs.google.com/spreadsheets/d/1LKeVmoCsUXTEQi4r7sFnbl9hGCIcFh_NdxXRgwfo160/pub?output=csv')
